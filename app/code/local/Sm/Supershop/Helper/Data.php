...
class Sm_Supershop_Helper_Data extends Mage_Core_Helper_Abstract{
	...
	function get($attributes=array()){
		...
		$rich_snippets_setting = Mage::getStoreConfig("supershop_cfg/rich_snippets_setting");
	...
	{
		/*$design_config=Mage::getStoreConfig('supershop_cfg/general/theme_color');
    ...
    {
        $lightBoxTypeJs = Mage::helper('supershop/config')->getProductSetting('lightbox_types');
    ...
    {
        $footerStyle = Mage::helper('supershop/config')->getThemeLayout('footer_style');
	...
	/* public function getDetailTemplate($store = null)
    {
		if (isset($_REQUEST['detail_style'])) {
			...
			$detail_style = Mage::helper('supershop/config')->getProductSetting('detail_style');
		}	

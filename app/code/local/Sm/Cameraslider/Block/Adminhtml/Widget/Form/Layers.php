...
class Sm_Cameraslider_Block_Adminhtml_Widget_Form_Layers extends Mage_Adminhtml_Block_Widget implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    protected function _prepareLayout()
    {
        ...
        $addLayerBtn = $this->getLayout()->createBlock( 'adminhtml/widget_button', 'addLayerVideoBtn', array(
            ...
            'onclick' => sprintf( '_MediabrowserUtility.openDialog(\'%s\', \'addLayerVideoWindow\', null, 700, \'%s\')', Mage::getSingleton( 'adminhtml/url' )->getUrl( 'sm_cameraslider/adminhtml_cameraslider/video' ), Mage::helper( 'sm_cameraslider' )->__( 'Add Video' ) ),
	        'id'        => 'addLayerVideoBtn'
        ) );
	...
	{
		return Mage::getSingleton( 'adminhtml/url' )->getUrl( 'sm_cameraslider/adminhtml_cameraslider/video' );
	}
}